...
function generateProgram() {
  ...
  let weeklyPlan = [
    ...
    { day: "Tuesday", focus: `Threshold Repeats (e.g., 4x1-mile @ ${fp.thresholdPace}/mile) + Bands`, percent: 0.18, isRun: true },
  ...
  switch (phaseInput) {
    case 'BASE':
      ...
      weeklyPlan[1].focus = `Light Fartlek (e.g., 5x2-min hard @ ${fp.intervalPace}/mile) + Bands`;
    ...
    case 'STRENGTH':
      ...
      weeklyPlan[1].focus = `Threshold Repeats (e.g., 4x1000m @ ${fp.thresholdPace}/mile) + Bands`;
    ...
    case 'PEAK':
      ...
      weeklyPlan[1].focus = `Intervals (e.g., 6x800m @ ${fp.intervalPace}/mile) + Bands`;
      weeklyPlan[3].focus = `Threshold Repeats (e.g., 3x1-mile @ ${fp.thresholdPace}/mile) + Bands`;
      break;
    case 'TAPER':
